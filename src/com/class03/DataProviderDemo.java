...
public class DataProviderDemo extends CommonMethods {
	...
	public Object[] [] getData(){
		...
		//2nd way 
		/*
		 * Object[][] data2=new Object[3][3]; data2 [0][0]= "Admin"; data2 [0][1]=
		 * "Hum@nhrm123"; data2 [0][2]= "23";
		 * 
		 * data2 [1][0]= "Syntax"; data2 [1][1]= "Syntax123!"; data2 [1][2]= "25";
		 * 
		 * data2 [2][0]= "SyntaxUser"; data2 [2][1]= "Syntax123"; data2 [2][2]= "20";
		 */
		return data;
	}
